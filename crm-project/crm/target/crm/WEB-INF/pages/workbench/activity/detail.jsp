                   ...
                   url:"workbench/activity/saveEditActivityRemark.do",
                    ...
                    success:function (data){
                       if(data.code=="1"){
                           ...
                           $("#div_"+id+" small").text(" "+editTime+"由${sessionScope.sessionUser.name}修改")
                       }else {
                           //不关闭并提示相应信息
                           alert(data.message);
                       }
        ...
        <div  id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
            ...
            <div style="position: relative; top: -40px; left: 40px;">
                ...
                <font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b><small
                    style="color: gray;">${remark.editFlag=='1'?remark.editTime:remark.createTime}由${remark.editFlag=='1'?remark.editBy:remark.createBy}${remark.editFlag=='1'?'创建':'修改'}</small>
