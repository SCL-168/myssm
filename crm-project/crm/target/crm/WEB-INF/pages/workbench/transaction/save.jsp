	...
	<script type="text/javascript">
		$(function (){
			...
			$("#create-stage").change(function (){
             //搜集参数
				var stageValue=$("#create-stage option:selected").text()//该下拉框被选择的
				//表单验证
				if(stageValue==""){
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-activityId" value="10978a365ef24de1ab64f6f5af3aeb6c">
				<input type="text" class="form-control" id="create-activityName" value="test03">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-contactsId" value="f078f5ceac3845539dd280071eda3f4b">
				<input type="text" class="form-control" id="create-contactsName" value="小卤蛋">
			</div>
		</div>
